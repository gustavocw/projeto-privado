...
import FiltroEmpresasPessoasBloc from './FiltroEmpresasPessoasBloc';
...
interface Props extends ViewProps<FiltroEmpresasPessoasBloc> {
  onFiltrar: (filtros: FiltroEmpresasPessoas) => void;
}

const FiltroEmpresasPessoasView: React.FC<Props> = (props: Props) => {
...
export default bindView(FiltroEmpresasPessoasView, FiltroEmpresasPessoasBloc);
